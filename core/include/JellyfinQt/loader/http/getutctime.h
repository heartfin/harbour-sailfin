...
#ifndef JELLYFIN_LOADER_HTTP_GETUTCTIME_H
#define JELLYFIN_LOADER_HTTP_GETUTCTIME_H
...
public:
	explicit GetUtcTime(ApiClient *apiClient);

protected:
	QString url(const GetUtcTimeParams& parameters) const override;
...
#endif // JELLYFIN_LOADER_HTTP_GETUTCTIME_H
