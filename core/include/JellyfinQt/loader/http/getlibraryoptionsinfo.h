...
#ifndef JELLYFIN_LOADER_HTTP_GETLIBRARYOPTIONSINFO_H
#define JELLYFIN_LOADER_HTTP_GETLIBRARYOPTIONSINFO_H
...
public:
	explicit GetLibraryOptionsInfo(ApiClient *apiClient);

protected:
	QString url(const GetLibraryOptionsInfoParams& parameters) const override;
...
#endif // JELLYFIN_LOADER_HTTP_GETLIBRARYOPTIONSINFO_H
