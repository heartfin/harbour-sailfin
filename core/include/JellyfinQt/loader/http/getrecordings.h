...
#ifndef JELLYFIN_LOADER_HTTP_GETRECORDINGS_H
#define JELLYFIN_LOADER_HTTP_GETRECORDINGS_H
...
public:
	explicit GetRecordings(ApiClient *apiClient);

protected:
	QString url(const GetRecordingsParams& parameters) const override;
...
#endif // JELLYFIN_LOADER_HTTP_GETRECORDINGS_H
