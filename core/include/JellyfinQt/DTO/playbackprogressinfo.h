...
#ifndef JELLYFIN_DTO_PLAYBACKPROGRESSINFO_H
#define JELLYFIN_DTO_PLAYBACKPROGRESSINFO_H
...
class PlaybackProgressInfo : public QObject {
	Q_OBJECT
public:
	explicit PlaybackProgressInfo(QObject *parent = nullptr);
	static PlaybackProgressInfo *fromJSON(QJsonObject source, QObject *parent = nullptr);
...
#endif // JELLYFIN_DTO_PLAYBACKPROGRESSINFO_H
