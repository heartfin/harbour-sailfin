...
#ifndef JELLYFIN_LOADER_HTTP_GETTHEMEVIDEOS_H
#define JELLYFIN_LOADER_HTTP_GETTHEMEVIDEOS_H
...
public:
	explicit GetThemeVideos(ApiClient *apiClient);

protected:
	QString url(const GetThemeVideosParams& parameters) const override;
...
#endif // JELLYFIN_LOADER_HTTP_GETTHEMEVIDEOS_H
