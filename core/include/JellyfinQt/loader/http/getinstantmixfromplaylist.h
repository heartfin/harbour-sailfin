...
#ifndef JELLYFIN_LOADER_HTTP_GETINSTANTMIXFROMPLAYLIST_H
#define JELLYFIN_LOADER_HTTP_GETINSTANTMIXFROMPLAYLIST_H
...
public:
	explicit GetInstantMixFromPlaylist(ApiClient *apiClient);

protected:
	QString url(const GetInstantMixFromPlaylistParams& parameters) const override;
...
#endif // JELLYFIN_LOADER_HTTP_GETINSTANTMIXFROMPLAYLIST_H
