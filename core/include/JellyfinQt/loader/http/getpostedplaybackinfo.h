...
#ifndef JELLYFIN_LOADER_HTTP_GETPOSTEDPLAYBACKINFO_H
#define JELLYFIN_LOADER_HTTP_GETPOSTEDPLAYBACKINFO_H
...
#endif // JELLYFIN_LOADER_HTTP_GETPOSTEDPLAYBACKINFO_H
