...
#ifndef JELLYFIN_LOADER_HTTP_GETPLAYLISTITEMS_H
#define JELLYFIN_LOADER_HTTP_GETPLAYLISTITEMS_H
...
public:
	explicit GetPlaylistItems(ApiClient *apiClient);

protected:
	QString url(const GetPlaylistItemsParams& parameters) const override;
...
#endif // JELLYFIN_LOADER_HTTP_GETPLAYLISTITEMS_H
