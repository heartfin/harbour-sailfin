...
#ifndef JELLYFIN_LOADER_HTTP_GETTHEMEMEDIA_H
#define JELLYFIN_LOADER_HTTP_GETTHEMEMEDIA_H
 ...
 */
class GetThemeMediaLoader : public Jellyfin::Support::HttpLoader<Jellyfin::DTO::AllThemeMediaResult, GetThemeMediaParams> {
public:
...
#endif // JELLYFIN_LOADER_HTTP_GETTHEMEMEDIA_H
