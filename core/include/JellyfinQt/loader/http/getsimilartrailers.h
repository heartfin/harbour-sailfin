...
#ifndef JELLYFIN_LOADER_HTTP_GETSIMILARTRAILERS_H
#define JELLYFIN_LOADER_HTTP_GETSIMILARTRAILERS_H
...
public:
	explicit GetSimilarTrailers(ApiClient *apiClient);

protected:
	QString url(const GetSimilarTrailersParams& parameters) const override;
...
#endif // JELLYFIN_LOADER_HTTP_GETSIMILARTRAILERS_H
