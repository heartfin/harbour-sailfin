...
#ifndef JELLYFIN_LOADER_HTTP_GETINSTANTMIXFROMMUSICGENRES_H
#define JELLYFIN_LOADER_HTTP_GETINSTANTMIXFROMMUSICGENRES_H
...
public:
	explicit GetInstantMixFromMusicGenres(ApiClient *apiClient);

protected:
	QString url(const GetInstantMixFromMusicGenresParams& parameters) const override;
...
#endif // JELLYFIN_LOADER_HTTP_GETINSTANTMIXFROMMUSICGENRES_H
