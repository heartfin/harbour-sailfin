...
#ifndef JELLYFIN_LOADER_HTTP_GETRECORDINGGROUPS_H
#define JELLYFIN_LOADER_HTTP_GETRECORDINGGROUPS_H
...
public:
	explicit GetRecordingGroups(ApiClient *apiClient);

protected:
	QString url(const GetRecordingGroupsParams& parameters) const override;
...
#endif // JELLYFIN_LOADER_HTTP_GETRECORDINGGROUPS_H
