...
#ifndef JELLYFIN_LOADER_HTTP_GETNOTIFICATIONSSUMMARY_H
#define JELLYFIN_LOADER_HTTP_GETNOTIFICATIONSSUMMARY_H
...
#endif // JELLYFIN_LOADER_HTTP_GETNOTIFICATIONSSUMMARY_H
