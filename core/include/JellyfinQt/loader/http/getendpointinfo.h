...
#ifndef JELLYFIN_LOADER_HTTP_GETENDPOINTINFO_H
#define JELLYFIN_LOADER_HTTP_GETENDPOINTINFO_H
...
public:
	explicit GetEndpointInfo(ApiClient *apiClient);

protected:
	QString url(const GetEndpointInfoParams& parameters) const override;
...
#endif // JELLYFIN_LOADER_HTTP_GETENDPOINTINFO_H
