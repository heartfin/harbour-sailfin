...
#ifndef JELLYFIN_LOADER_HTTP_GETITEMSBYUSERID_H
#define JELLYFIN_LOADER_HTTP_GETITEMSBYUSERID_H
...
public:
	explicit GetItemsByUserId(ApiClient *apiClient);

protected:
	QString url(const GetItemsByUserIdParams& parameters) const override;
...
#endif // JELLYFIN_LOADER_HTTP_GETITEMSBYUSERID_H
