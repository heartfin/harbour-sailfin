...
#ifndef JELLYFIN_LOADER_HTTP_GETPACKAGEINFO_H
#define JELLYFIN_LOADER_HTTP_GETPACKAGEINFO_H
...
public:
	explicit GetPackageInfo(ApiClient *apiClient);

protected:
	QString url(const GetPackageInfoParams& parameters) const override;
...
#endif // JELLYFIN_LOADER_HTTP_GETPACKAGEINFO_H
