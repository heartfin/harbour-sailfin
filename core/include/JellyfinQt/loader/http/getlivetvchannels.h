...
#ifndef JELLYFIN_LOADER_HTTP_GETLIVETVCHANNELS_H
#define JELLYFIN_LOADER_HTTP_GETLIVETVCHANNELS_H
...
public:
	explicit GetLiveTvChannels(ApiClient *apiClient);

protected:
	QString url(const GetLiveTvChannelsParams& parameters) const override;
...
#endif // JELLYFIN_LOADER_HTTP_GETLIVETVCHANNELS_H
