...
#ifndef JELLYFIN_LOADER_HTTP_GETSUGGESTIONS_H
#define JELLYFIN_LOADER_HTTP_GETSUGGESTIONS_H
...
public:
	explicit GetSuggestions(ApiClient *apiClient);

protected:
	QString url(const GetSuggestionsParams& parameters) const override;
...
#endif // JELLYFIN_LOADER_HTTP_GETSUGGESTIONS_H
