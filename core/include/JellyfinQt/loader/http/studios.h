...
#ifndef JELLYFIN_LOADER_HTTP_STUDIOS_H
#define JELLYFIN_LOADER_HTTP_STUDIOS_H
...
class GetStudiosLoader : public Jellyfin::Support::HttpLoader<BaseItemDtoQueryResult, GetStudiosParams> {
public:
...
class GetStudioLoader : public Jellyfin::Support::HttpLoader<BaseItemDto, GetStudioParams> {
public:
...
#endif // JELLYFIN_LOADER_HTTP_STUDIOS_H
