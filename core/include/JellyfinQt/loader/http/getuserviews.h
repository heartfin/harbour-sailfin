...
#ifndef JELLYFIN_LOADER_HTTP_GETUSERVIEWS_H
#define JELLYFIN_LOADER_HTTP_GETUSERVIEWS_H
...
public:
	explicit GetUserViews(ApiClient *apiClient);

protected:
	QString url(const GetUserViewsParams& parameters) const override;
...
#endif // JELLYFIN_LOADER_HTTP_GETUSERVIEWS_H
