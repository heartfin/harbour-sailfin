...
#ifndef JELLYFIN_LOADER_HTTP_GETRECORDINGSSERIES_H
#define JELLYFIN_LOADER_HTTP_GETRECORDINGSSERIES_H
...
public:
	explicit GetRecordingsSeries(ApiClient *apiClient);

protected:
	QString url(const GetRecordingsSeriesParams& parameters) const override;
...
#endif // JELLYFIN_LOADER_HTTP_GETRECORDINGSSERIES_H
