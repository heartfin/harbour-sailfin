...
#ifndef JELLYFIN_LOADER_HTTP_GETSERIESTIMER_H
#define JELLYFIN_LOADER_HTTP_GETSERIESTIMER_H
...
public:
	explicit GetSeriesTimer(ApiClient *apiClient);

protected:
	QString url(const GetSeriesTimerParams& parameters) const override;
...
#endif // JELLYFIN_LOADER_HTTP_GETSERIESTIMER_H
