...
#ifndef JELLYFIN_DTO_PLAYSTATECOMMAND_H
...
public:
	...
	Q_ENUM(Value)
private:
	explicit PlaystateCommandClass();
};

using PlaystateCommand = PlaystateCommandClass::Value;
...
#endif // JELLYFIN_DTO_PLAYSTATECOMMAND_H
