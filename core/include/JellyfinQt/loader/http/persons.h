...
#ifndef JELLYFIN_LOADER_HTTP_PERSONS_H
#define JELLYFIN_LOADER_HTTP_PERSONS_H
...
class GetPersonsLoader : public Jellyfin::Support::HttpLoader<BaseItemDtoQueryResult, GetPersonsParams> {
public:
...
class GetPersonLoader : public Jellyfin::Support::HttpLoader<BaseItemDto, GetPersonParams> {
public:
...
#endif // JELLYFIN_LOADER_HTTP_PERSONS_H
