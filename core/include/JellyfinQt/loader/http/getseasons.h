...
#ifndef JELLYFIN_LOADER_HTTP_GETSEASONS_H
#define JELLYFIN_LOADER_HTTP_GETSEASONS_H
...
public:
	explicit GetSeasons(ApiClient *apiClient);

protected:
	QString url(const GetSeasonsParams& parameters) const override;
...
#endif // JELLYFIN_LOADER_HTTP_GETSEASONS_H
