...
#ifndef JELLYFIN_LOADER_HTTP_GETPERSONS_H
#define JELLYFIN_LOADER_HTTP_GETPERSONS_H
...
public:
	explicit GetPersons(ApiClient *apiClient);

protected:
	QString url(const GetPersonsParams& parameters) const override;
...
#endif // JELLYFIN_LOADER_HTTP_GETPERSONS_H
