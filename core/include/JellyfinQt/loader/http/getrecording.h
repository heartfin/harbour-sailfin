...
#ifndef JELLYFIN_LOADER_HTTP_GETRECORDING_H
...
public:
	explicit GetRecording(ApiClient *apiClient);

protected:
	QString url(const GetRecordingParams& parameters) const override;
...
#endif // JELLYFIN_LOADER_HTTP_GETRECORDING_H
