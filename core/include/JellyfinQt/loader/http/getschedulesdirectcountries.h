...
#ifndef JELLYFIN_LOADER_HTTP_GETSCHEDULESDIRECTCOUNTRIES_H
#define JELLYFIN_LOADER_HTTP_GETSCHEDULESDIRECTCOUNTRIES_H
...
#endif // JELLYFIN_LOADER_HTTP_GETSCHEDULESDIRECTCOUNTRIES_H
