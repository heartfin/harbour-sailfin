...
#ifndef JELLYFIN_DTO_MOVIEINFO_H
#define JELLYFIN_DTO_MOVIEINFO_H
...
public:
	...
	static MovieInfo *fromJSON(QJsonObject source, QObject *parent = nullptr);
...
#endif // JELLYFIN_DTO_MOVIEINFO_H
