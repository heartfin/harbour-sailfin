...
#ifndef JELLYFIN_LOADER_HTTP_GETSIMILARSHOWS_H
#define JELLYFIN_LOADER_HTTP_GETSIMILARSHOWS_H
...
public:
	explicit GetSimilarShows(ApiClient *apiClient);

protected:
	QString url(const GetSimilarShowsParams& parameters) const override;
...
#endif // JELLYFIN_LOADER_HTTP_GETSIMILARSHOWS_H
