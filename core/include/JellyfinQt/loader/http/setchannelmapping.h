...
#ifndef JELLYFIN_LOADER_HTTP_SETCHANNELMAPPING_H
#define JELLYFIN_LOADER_HTTP_SETCHANNELMAPPING_H
...
public:
	explicit SetChannelMapping(ApiClient *apiClient);

protected:
	QString url(const SetChannelMappingParams& parameters) const override;
...
#endif // JELLYFIN_LOADER_HTTP_SETCHANNELMAPPING_H
