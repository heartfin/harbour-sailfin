...
#ifndef JELLYFIN_LOADER_HTTP_GETSTARTUPCONFIGURATION_H
#define JELLYFIN_LOADER_HTTP_GETSTARTUPCONFIGURATION_H
...
public:
	explicit GetStartupConfiguration(ApiClient *apiClient);

protected:
	QString url(const GetStartupConfigurationParams& parameters) const override;
...
#endif // JELLYFIN_LOADER_HTTP_GETSTARTUPCONFIGURATION_H
