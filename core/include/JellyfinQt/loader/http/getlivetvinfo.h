...
#ifndef JELLYFIN_LOADER_HTTP_GETLIVETVINFO_H
...
public:
	explicit GetLiveTvInfo(ApiClient *apiClient);

protected:
	QString url(const GetLiveTvInfoParams& parameters) const override;
...
#endif // JELLYFIN_LOADER_HTTP_GETLIVETVINFO_H
