...
#ifndef JELLYFIN_LOADER_HTTP_GETPROGRAMS_H
#define JELLYFIN_LOADER_HTTP_GETPROGRAMS_H
...
public:
	explicit GetPrograms(ApiClient *apiClient);

protected:
	QString url(const GetProgramsParams& parameters) const override;
...
#endif // JELLYFIN_LOADER_HTTP_GETPROGRAMS_H
