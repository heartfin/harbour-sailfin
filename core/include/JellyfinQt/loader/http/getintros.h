...
#ifndef JELLYFIN_LOADER_HTTP_GETINTROS_H
#define JELLYFIN_LOADER_HTTP_GETINTROS_H
...
public:
	explicit GetIntros(ApiClient *apiClient);

protected:
	QString url(const GetIntrosParams& parameters) const override;
...
#endif // JELLYFIN_LOADER_HTTP_GETINTROS_H
