...
void LocalizationOption::replaceData(LocalizationOption &other) {
	m_name = other.m_name;
	m_value = other.m_value;
}
...
bool LocalizationOption::nameNull() const {
	return m_name.isNull();
}

void LocalizationOption::setNameNull() {
	m_name.clear();
...
bool LocalizationOption::valueNull() const {
	return m_value.isNull();
}

void LocalizationOption::setValueNull() {
	m_value.clear();
