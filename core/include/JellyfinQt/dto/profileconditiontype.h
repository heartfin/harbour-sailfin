...
#ifndef JELLYFIN_DTO_PROFILECONDITIONTYPE_H
...
class ProfileConditionTypeClass {
	Q_GADGET
public:
	enum Value {
		EnumNotSet,
	...
	Q_ENUM(Value)
private:
	explicit ProfileConditionTypeClass();
};

using ProfileConditionType = ProfileConditionTypeClass::Value;
...
#endif // JELLYFIN_DTO_PROFILECONDITIONTYPE_H
