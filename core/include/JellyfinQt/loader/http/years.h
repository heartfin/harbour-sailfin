...
#ifndef JELLYFIN_LOADER_HTTP_YEARS_H
#define JELLYFIN_LOADER_HTTP_YEARS_H
...
class GetYearsLoader : public Jellyfin::Support::HttpLoader<BaseItemDtoQueryResult, GetYearsParams> {
public:
	explicit GetYearsLoader(ApiClient *apiClient = nullptr);
...
class GetYearLoader : public Jellyfin::Support::HttpLoader<BaseItemDto, GetYearParams> {
public:
...
#endif // JELLYFIN_LOADER_HTTP_YEARS_H
