...
#ifndef JELLYFIN_LOADER_HTTP_GETTRAILERS_H
#define JELLYFIN_LOADER_HTTP_GETTRAILERS_H
...
public:
	explicit GetTrailers(ApiClient *apiClient);

protected:
	QString url(const GetTrailersParams& parameters) const override;
...
#endif // JELLYFIN_LOADER_HTTP_GETTRAILERS_H
