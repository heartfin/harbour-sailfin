...
#ifndef JELLYFIN_LOADER_HTTP_GETNOTIFICATIONS_H
#define JELLYFIN_LOADER_HTTP_GETNOTIFICATIONS_H
...
public:
	explicit GetNotifications(ApiClient *apiClient);

protected:
	QString url(const GetNotificationsParams& parameters) const override;
...
#endif // JELLYFIN_LOADER_HTTP_GETNOTIFICATIONS_H
