...
#ifndef JELLYFIN_LOADER_HTTP_GETITEMS_H
#define JELLYFIN_LOADER_HTTP_GETITEMS_H
...
public:
	explicit GetItems(ApiClient *apiClient);

protected:
	QString url(const GetItemsParams& parameters) const override;
...
#endif // JELLYFIN_LOADER_HTTP_GETITEMS_H
