...
#ifndef JELLYFIN_LOADER_HTTP_GETMETADATAEDITORINFO_H
#define JELLYFIN_LOADER_HTTP_GETMETADATAEDITORINFO_H
...
public:
	explicit GetMetadataEditorInfo(ApiClient *apiClient);

protected:
	QString url(const GetMetadataEditorInfoParams& parameters) const override;
...
#endif // JELLYFIN_LOADER_HTTP_GETMETADATAEDITORINFO_H
