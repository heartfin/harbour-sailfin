...
#ifndef JELLYFIN_LOADER_HTTP_GETINSTANTMIXFROMITEM_H
#define JELLYFIN_LOADER_HTTP_GETINSTANTMIXFROMITEM_H
...
public:
	explicit GetInstantMixFromItem(ApiClient *apiClient);

protected:
	QString url(const GetInstantMixFromItemParams& parameters) const override;
...
#endif // JELLYFIN_LOADER_HTTP_GETINSTANTMIXFROMITEM_H
