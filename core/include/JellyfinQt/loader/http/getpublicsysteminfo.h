...
#ifndef JELLYFIN_LOADER_HTTP_GETPUBLICSYSTEMINFO_H
#define JELLYFIN_LOADER_HTTP_GETPUBLICSYSTEMINFO_H
...
public:
	explicit GetPublicSystemInfo(ApiClient *apiClient);

protected:
	QString url(const GetPublicSystemInfoParams& parameters) const override;
...
#endif // JELLYFIN_LOADER_HTTP_GETPUBLICSYSTEMINFO_H
