...
#ifndef JELLYFIN_LOADER_HTTP_GETREMOTEIMAGES_H
#define JELLYFIN_LOADER_HTTP_GETREMOTEIMAGES_H
...
public:
	explicit GetRemoteImages(ApiClient *apiClient);

protected:
	QString url(const GetRemoteImagesParams& parameters) const override;
...
#endif // JELLYFIN_LOADER_HTTP_GETREMOTEIMAGES_H
