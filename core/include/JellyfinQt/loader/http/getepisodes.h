...
#ifndef JELLYFIN_LOADER_HTTP_GETEPISODES_H
#define JELLYFIN_LOADER_HTTP_GETEPISODES_H
...
public:
	explicit GetEpisodes(ApiClient *apiClient);

protected:
	QString url(const GetEpisodesParams& parameters) const override;
...
#endif // JELLYFIN_LOADER_HTTP_GETEPISODES_H
