...
std::optional<QJsonObject> PersonLookupInfo::providerIds() const { return m_providerIds; }

void PersonLookupInfo::setProviderIds(std::optional<QJsonObject> newProviderIds) {
