...
#ifndef JELLYFIN_LOADER_HTTP_GETMUSICGENRES_H
#define JELLYFIN_LOADER_HTTP_GETMUSICGENRES_H
...
public:
	explicit GetMusicGenres(ApiClient *apiClient);

protected:
	QString url(const GetMusicGenresParams& parameters) const override;
...
#endif // JELLYFIN_LOADER_HTTP_GETMUSICGENRES_H
