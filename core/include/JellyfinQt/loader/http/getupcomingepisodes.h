...
#ifndef JELLYFIN_LOADER_HTTP_GETUPCOMINGEPISODES_H
#define JELLYFIN_LOADER_HTTP_GETUPCOMINGEPISODES_H
...
public:
	explicit GetUpcomingEpisodes(ApiClient *apiClient);

protected:
	QString url(const GetUpcomingEpisodesParams& parameters) const override;
...
#endif // JELLYFIN_LOADER_HTTP_GETUPCOMINGEPISODES_H
