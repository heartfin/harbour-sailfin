...
#ifndef JELLYFIN_LOADER_HTTP_GETTIMERS_H
#define JELLYFIN_LOADER_HTTP_GETTIMERS_H
 ...
 */
class GetTimersLoader : public Jellyfin::Support::HttpLoader<Jellyfin::DTO::TimerInfoDtoQueryResult, GetTimersParams> {
public:
...
#endif // JELLYFIN_LOADER_HTTP_GETTIMERS_H
