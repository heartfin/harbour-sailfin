...
#ifndef JELLYFIN_LOADER_HTTP_GETPLAYBACKINFO_H
#define JELLYFIN_LOADER_HTTP_GETPLAYBACKINFO_H
...
public:
	explicit GetPlaybackInfo(ApiClient *apiClient);

protected:
	QString url(const GetPlaybackInfoParams& parameters) const override;
...
#endif // JELLYFIN_LOADER_HTTP_GETPLAYBACKINFO_H
