...
#ifndef JELLYFIN_DTO_SERIESINFO_H
#define JELLYFIN_DTO_SERIESINFO_H
...
public:
	 ...
	 */
	void replaceData(SeriesInfo &other);
...
private:
	// Private constructor which generates an invalid object, for use withing SeriesInfo::fromJson();
	SeriesInfo();
};
...
#endif // JELLYFIN_DTO_SERIESINFO_H
