...
#ifndef JELLYFIN_LOADER_HTTP_GETNEXTUP_H
#define JELLYFIN_LOADER_HTTP_GETNEXTUP_H
...
public:
	explicit GetNextUp(ApiClient *apiClient);

protected:
	QString url(const GetNextUpParams& parameters) const override;
...
#endif // JELLYFIN_LOADER_HTTP_GETNEXTUP_H
