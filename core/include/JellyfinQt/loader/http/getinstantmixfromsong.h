...
#ifndef JELLYFIN_LOADER_HTTP_GETINSTANTMIXFROMSONG_H
#define JELLYFIN_LOADER_HTTP_GETINSTANTMIXFROMSONG_H
...
public:
	explicit GetInstantMixFromSong(ApiClient *apiClient);

protected:
	QString url(const GetInstantMixFromSongParams& parameters) const override;
...
#endif // JELLYFIN_LOADER_HTTP_GETINSTANTMIXFROMSONG_H
