...
#ifndef JELLYFIN_DTO_TRAILERINFO_H
#define JELLYFIN_DTO_TRAILERINFO_H
...
public:
	...
	TrailerInfo(const TrailerInfo &other);
	
	/**
	 * Replaces the data being hold by this class with that of the other.
	 */
	void replaceData(TrailerInfo &other);
...
private:
	// Private constructor which generates an invalid object, for use withing TrailerInfo::fromJson();
	TrailerInfo();
};
...
#endif // JELLYFIN_DTO_TRAILERINFO_H
