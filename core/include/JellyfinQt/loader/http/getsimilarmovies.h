...
#ifndef JELLYFIN_LOADER_HTTP_GETSIMILARMOVIES_H
#define JELLYFIN_LOADER_HTTP_GETSIMILARMOVIES_H
...
public:
	explicit GetSimilarMovies(ApiClient *apiClient);

protected:
	QString url(const GetSimilarMoviesParams& parameters) const override;
...
#endif // JELLYFIN_LOADER_HTTP_GETSIMILARMOVIES_H
