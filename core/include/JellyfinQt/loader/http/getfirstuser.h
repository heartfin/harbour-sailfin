...
#ifndef JELLYFIN_LOADER_HTTP_GETFIRSTUSER_H
#define JELLYFIN_LOADER_HTTP_GETFIRSTUSER_H
...
public:
	explicit GetFirstUser(ApiClient *apiClient);

protected:
	QString url(const GetFirstUserParams& parameters) const override;
...
#endif // JELLYFIN_LOADER_HTTP_GETFIRSTUSER_H
