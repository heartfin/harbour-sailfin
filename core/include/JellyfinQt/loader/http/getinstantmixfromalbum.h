...
#ifndef JELLYFIN_LOADER_HTTP_GETINSTANTMIXFROMALBUM_H
#define JELLYFIN_LOADER_HTTP_GETINSTANTMIXFROMALBUM_H
...
public:
	explicit GetInstantMixFromAlbum(ApiClient *apiClient);

protected:
	QString url(const GetInstantMixFromAlbumParams& parameters) const override;
...
#endif // JELLYFIN_LOADER_HTTP_GETINSTANTMIXFROMALBUM_H
