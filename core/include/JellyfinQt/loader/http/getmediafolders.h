...
#ifndef JELLYFIN_LOADER_HTTP_GETMEDIAFOLDERS_H
...
public:
	explicit GetMediaFolders(ApiClient *apiClient);

protected:
	QString url(const GetMediaFoldersParams& parameters) const override;
...
#endif // JELLYFIN_LOADER_HTTP_GETMEDIAFOLDERS_H
