...
#ifndef JELLYFIN_LOADER_HTTP_GETINSTANTMIXFROMMUSICGENRE_H
#define JELLYFIN_LOADER_HTTP_GETINSTANTMIXFROMMUSICGENRE_H
...
public:
	explicit GetInstantMixFromMusicGenre(ApiClient *apiClient);

protected:
	QString url(const GetInstantMixFromMusicGenreParams& parameters) const override;
...
#endif // JELLYFIN_LOADER_HTTP_GETINSTANTMIXFROMMUSICGENRE_H
