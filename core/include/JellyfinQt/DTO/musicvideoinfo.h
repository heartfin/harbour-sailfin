...
#ifndef JELLYFIN_DTO_MUSICVIDEOINFO_H
#define JELLYFIN_DTO_MUSICVIDEOINFO_H
...
class MusicVideoInfo : public QObject {
	Q_OBJECT
public:
	explicit MusicVideoInfo(QObject *parent = nullptr);
	static MusicVideoInfo *fromJSON(QJsonObject source, QObject *parent = nullptr);
...
#endif // JELLYFIN_DTO_MUSICVIDEOINFO_H
