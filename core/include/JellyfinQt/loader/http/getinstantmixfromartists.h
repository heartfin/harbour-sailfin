...
#ifndef JELLYFIN_LOADER_HTTP_GETINSTANTMIXFROMARTISTS_H
#define JELLYFIN_LOADER_HTTP_GETINSTANTMIXFROMARTISTS_H
...
public:
	explicit GetInstantMixFromArtists(ApiClient *apiClient);

protected:
	QString url(const GetInstantMixFromArtistsParams& parameters) const override;
...
#endif // JELLYFIN_LOADER_HTTP_GETINSTANTMIXFROMARTISTS_H
