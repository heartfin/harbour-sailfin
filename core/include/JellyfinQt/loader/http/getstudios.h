...
#ifndef JELLYFIN_LOADER_HTTP_GETSTUDIOS_H
#define JELLYFIN_LOADER_HTTP_GETSTUDIOS_H
...
public:
	explicit GetStudios(ApiClient *apiClient);

protected:
	QString url(const GetStudiosParams& parameters) const override;
...
#endif // JELLYFIN_LOADER_HTTP_GETSTUDIOS_H
