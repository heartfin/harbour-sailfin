...
#ifndef JELLYFIN_LOADER_HTTP_GETSIMILARARTISTS_H
#define JELLYFIN_LOADER_HTTP_GETSIMILARARTISTS_H
...
public:
	explicit GetSimilarArtists(ApiClient *apiClient);

protected:
	QString url(const GetSimilarArtistsParams& parameters) const override;
...
#endif // JELLYFIN_LOADER_HTTP_GETSIMILARARTISTS_H
