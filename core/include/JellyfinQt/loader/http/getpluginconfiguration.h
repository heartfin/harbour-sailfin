...
#ifndef JELLYFIN_LOADER_HTTP_GETPLUGINCONFIGURATION_H
#define JELLYFIN_LOADER_HTTP_GETPLUGINCONFIGURATION_H
...
#endif // JELLYFIN_LOADER_HTTP_GETPLUGINCONFIGURATION_H
