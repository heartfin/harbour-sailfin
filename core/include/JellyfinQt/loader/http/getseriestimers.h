...
#ifndef JELLYFIN_LOADER_HTTP_GETSERIESTIMERS_H
#define JELLYFIN_LOADER_HTTP_GETSERIESTIMERS_H
...
public:
	explicit GetSeriesTimers(ApiClient *apiClient);

protected:
	QString url(const GetSeriesTimersParams& parameters) const override;
...
#endif // JELLYFIN_LOADER_HTTP_GETSERIESTIMERS_H
