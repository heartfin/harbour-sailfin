...
#ifndef JELLYFIN_DTO_TIMERINFODTOQUERYRESULT_H
#define JELLYFIN_DTO_TIMERINFODTOQUERYRESULT_H
...
class TimerInfoDtoQueryResult : public QObject {
	Q_OBJECT
public:
	explicit TimerInfoDtoQueryResult(QObject *parent = nullptr);
	static TimerInfoDtoQueryResult *fromJSON(QJsonObject source, QObject *parent = nullptr);
	 ...
	 */
	Q_PROPERTY(QList<TimerInfoDto *> items READ items WRITE setItems NOTIFY itemsChanged)
	/**
...
signals:
	void itemsChanged(QList<TimerInfoDto *> newItems);
...
#endif // JELLYFIN_DTO_TIMERINFODTOQUERYRESULT_H
