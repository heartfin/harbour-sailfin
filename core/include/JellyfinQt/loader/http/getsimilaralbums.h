...
#ifndef JELLYFIN_LOADER_HTTP_GETSIMILARALBUMS_H
#define JELLYFIN_LOADER_HTTP_GETSIMILARALBUMS_H
...
public:
	explicit GetSimilarAlbums(ApiClient *apiClient);

protected:
	QString url(const GetSimilarAlbumsParams& parameters) const override;
...
#endif // JELLYFIN_LOADER_HTTP_GETSIMILARALBUMS_H
