...
#ifndef JELLYFIN_LOADER_HTTP_INITIATE_H
#define JELLYFIN_LOADER_HTTP_INITIATE_H
...
public:
	explicit Initiate(ApiClient *apiClient);

protected:
	QString url(const InitiateParams& parameters) const override;
...
#endif // JELLYFIN_LOADER_HTTP_INITIATE_H
